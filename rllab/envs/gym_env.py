...
class GymEnv(Env, Serializable):
    def __init__(self, env_name, record_video=True, video_schedule=None, log_dir=None, record_log=True, **kwargs):
        if log_dir is None:
        ...
        if log_dir is None or record_log is False:
            ...
            self.env.monitor.start(log_dir, video_schedule, force=False)  # add 'force=True' if want overwrite dirs
