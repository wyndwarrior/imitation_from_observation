...
register(
    id='Reacher-v2',
    entry_point='gym.envs.mujoco:ReacherEnv2',
    timestep_limit=50,
    reward_threshold=-3.75,
)
...
register(
    id='Pusher3DOFReal-v1',
    entry_point='gym.envs.mujoco:PusherEnv3DOFReal',
)
register(
    id='Pusher7DOF-v1',
    entry_point='gym.envs.mujoco:PusherEnv7DOF',
)
register(
    id='Pusher7DOFExp-v1',
    entry_point='gym.envs.mujoco:PusherEnv7DOFExp',
)
register(
    id='Pusher7DOFExp2-v1',
    entry_point='gym.envs.mujoco:PusherEnv7DOFExp2',
)
register(
    id='TexturedPusher7DOFExp2-v1',
    entry_point='gym.envs.mujoco:TexturedPusherEnv7DOFExp2',
)
register(
    id='MultiViewPusher-v0',
    entry_point='gym.envs.mujoco:MultiViewPusher',
)
register(
    id='Custom-v1',
    entry_point='gym.envs.mujoco:CustomEnv',
)
register(
    id='Custom7DOF-v1',
    entry_point='gym.envs.mujoco:CustomEnv7DOF',
)
register(
    id='Custom7DOFExp-v1',
    entry_point='gym.envs.mujoco:CustomEnv7DOFExp',
)
register(
    id='Custom7DOFExp2-v1',
    entry_point='gym.envs.mujoco:CustomEnv7DOFExp2',
)
register(
    id='Grasper-v1',
    entry_point='gym.envs.mujoco:GrasperEnv',
)
