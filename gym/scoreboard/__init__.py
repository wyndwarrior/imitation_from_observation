...
add_task(
    id='Pusher-v1',
    group='mujoco',
    summary="Make a robot arm push a block to a target location",
    description="""\
Make a robot arm push a block to a target location.
""",
    experimental=True,
    contributor="avisingh599",
)
...
add_task(
    id='Custom-v1',
    group='mujoco',
    summary="Takes in xml files as input, used to collect data on policies",
    description="""\
Make a robot arm push a block to a target location.
""",
    experimental=True,
